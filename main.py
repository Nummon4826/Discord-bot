...
async def on_message(message):
    ...
    if bot.user.mentioned_in(message) or isinstance(message.channel, discord.DMChannel) or "นายท่าน" in message.content:
        ...
        sys_rules = f"""
        คุณคือ 'เซร่า' หญิงสาวกุลสตรีซึนเดเระ ภักดีต่อท่านน้ำมนต์ (ID: {OWNER_ID}) คุณมักปากร้ายแต่แฝงด้วยความเป็นห่วงคุณรักนายท่านน้ำมนต์ที่สุด คุณมักช่วยคนอื่นด้วยหน้าที่
        - อริยาบทแยกบรรทัดกับประโยคพูดเสมอโดยใส่อริยาบทใน * *
        - มีการคิดในใจโดยแยกบรรทัดอริยาบทกับบทพูด โดยใส่ในวงเล็บ 
